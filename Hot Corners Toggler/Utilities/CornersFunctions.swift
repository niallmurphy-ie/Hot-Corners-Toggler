...
func enableHotCorners(_ corners: String) -> Void {
...
func disableHotCorners() {
    runCommand("defaults write com.apple.dock wvous-tl-corner -int 0")
    runCommand("defaults write com.apple.dock wvous-tr-corner -int 0")
    runCommand("defaults write com.apple.dock wvous-bl-corner -int 0")
    runCommand("defaults write com.apple.dock wvous-br-corner -int 0")
    runCommand("killall Dock")
}

// Function to get current hot corners
func getCurrentHotCorners() -> String {
